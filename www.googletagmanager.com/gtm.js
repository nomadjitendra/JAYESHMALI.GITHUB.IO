...
(function() {
    ...
    */
    ...
    S.ud = "370";
    S.V = "dataLayer";
    S.lh = "ChAIgL2hkQYQn5DkzcnWqo4PEiMAKizoly0MtLv1ruwmYMMMcuAPKCtb89UYwv58wrVsHIhFHRoCuiI\x3d";
    var Zd = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
    ...
    var de = Aa(""),
        ee = null,
        fe = null,
        ge = "https://www.googletagmanager.com/a?id=" + S.H + "&cv=53",
        ke = {},
        le = {},
        me = function() {
            var a = T.sequence || 1;
            ...
            (function(m) {
                ...
                if (na(F)) {
                    ...
                    if ("TRACK_TRANSACTION" == m.vtp_trackType) {
                        ...
                        for (var N = I("Products") || [], L = 0; L < N.length; L++) {
                            var K = N[L];
                            P("ecommerce:addItem", {
                                id: M,
                                sku: K.sku,
    ...
    Z.g.hl = ["google"],
        function() {
            function a(f) {
                return f.target && f.target.location && f.target.location.href ? f.target.location.href : oq()
            }
